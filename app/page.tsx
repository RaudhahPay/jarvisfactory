    ...
    <div style={s.body}>
      ...
      <nav style={s.nav}>
        ...
        <div style={s.navRight}>
          <button style={s.loginBtn} onClick={() => router.push('/auth')}>Log in</button>
          <button style={s.startBtn} onClick={() => router.push('/auth')}>Get started</button>
        </div>
      </nav>
      ...
      <header style={s.hero}>
        ...
        <div style={s.box}>
          ...
          />
          <div style={s.boxRow}>
            <button style={s.plusBtn} title="Add context" onClick={() => router.push('/auth')}>+</button>
      ...
      <footer style={s.footer}>
        ...
        <button style={s.startBtn} onClick={() => router.push('/auth')}>Start building →</button>
      </footer>
    </div>
  )
}
