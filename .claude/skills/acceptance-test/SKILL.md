...
Steps:
1. Determine scope from `(the user's input / arguments for this command)` (a change set, a release, and/or a target platform). Default: the changes on the current branch.
